...
for (let i = 0; i < starWarsCharacters.length; i++) {
  const personaggiF = starWarsCharacters[i];
  if (personaggiF.gender === "female") {
    delete personaggiF.height
    delete personaggiF.mass
    delete personaggiF.skin_color
    delete personaggiF.birth_year
    delete personaggiF.gender
    console.log(personaggiF);
  }
...
// */
for (let i = 0; i < starWarsCharacters.length; i++) {
  let occhi = starWarsCharacters[i].eye_color;
  switch (occhi) {
    case "blue":
